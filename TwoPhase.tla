This specification appeared in the paper

  Jim Gray and Leslie Lamport: "Consensus on Transaction Commit"  
  ACM Transactions on Database Systems 31, 1 (2006), 133-160, 
...
(* defines TC!TCSpec to be formula TSpec of module TCommit.  (The TLA+     *)
(* INSTANCE statement is used to rename the operators defined in module    *)
(* TCommit to avoid any name conflicts that might exist with operators in  *)
(* the current module.)                                                    *)
(***************************************************************************)
TC == INSTANCE TCommit 
